...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "7Ul1HARR#x7zpGlcjZYt3elHbjKKmVJTnBnutqywccyWgdxqjt7E", // session id  
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
MODE: process.env.MODE || "private", //public , groups , inbox
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94764180362", // ඔයාගෙ නම්බර් එක
OWNER_EMOJI: process.env.OWNER_EMOJI || "👽", // ඉමෝජි
BOT_NAME: process.env.BOT_NAME || "*JANI-MD*", // බොට් නම
...
OWNER_NAME: process.env.OWNER_NAME || "Janith Pramodya", // නම
FOOTER: process.env.FOOTER || "> *OWNER JANITH PRAMODYA🔰*",
